...
Check the exposure of admin panels using nucleai exposed panels tags.

### Description

Check the exposure of admin panels using nucleai exposed panels tags and insert vulnerabilities according to the template severity
